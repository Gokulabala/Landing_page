...
const Features = () => {
  return (
    <section className="relative h-[700px] flex w-full">
      ...
      <div className="flex w-1/2 flex-col gap-[32px] mt-[100px] ml-[30px]">
        <div className="gap-1">
        ...
        <div className="flex flex-col">
          <div className="flex flex-col gap-3">
            ...
            <p className="font-clashDisplayMedium text-[18px] leading-[28px] opacity-[40%] w-[638px]">
